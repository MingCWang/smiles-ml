...
2. Created a database on MongoDB atlas to store prediction results and perform caching.
...
5. Developed 4 REST API end points https://ml-latest-zsx7.onrender.com/docs
